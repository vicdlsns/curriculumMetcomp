...
\begin{tabular}{>{\bfseries}r | p{0.5\textwidth} c}
     \cvevent{20xx--20xx}{não-Estágio - Coach Astrológico}{Laboratório de Exoplanetas}{Instituto Nacional de Astrologia e Signos (INSigno) \color{cvred}}{\lorem.
    }{bird.png} \\
	...
	\cvevent{20xx--20xx}{não-IC - Marteplanismo: Fato ou Fake?}{Laboratório de Negacionismo Aplicado}{Universidade Federal de Ratanabá (UFRTB) \color{cvred}}{\lorem.
}{bird.png} \\
    \cvevent{2020--20xx}{IC - Programação para Arquitetura}{Laboratório de Modelos e Fabricação Digital}{FAU/UFRJ \color{cvred}}{Planejamento de uma disciplina de programação mista de visual em Grasshopper e textual em Python voltada a alunos das áreas de arquitetura e urbanismo. Inclui apresentação dos trabalhos na Semana de Integração Acadêmica (SIAc).
}{ufrj.png} \\
